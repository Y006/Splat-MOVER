...
if gaussian_splatting:
    config_path = Path(f"/home/jatucker/droneVLA/DroneVLA/data/splats/gsplats/gate_nav_left_9_5_2025_colmap/sagesplat/2025-09-08_101915/config.yml")
    config_path = Path(f"/home/jatucker/data/data/splats/gsplats/left_gate_9_24_2025_COLMAP/sagesplat/2025-10-06_215922/config.yml")
else:
    # ASK-NeRF
    config_path = Path(f"<config.yml>")

# name of the scene
scene_name = "left_gate_9_24_2025_COLMAP"
...
for trial_idx in range(num_trials):
    ...
    np.save(f"{pcd_output_dir}/table_mask.npy", table_mask)
    np.save(f"{pcd_output_dir}/table_points.npy", table_pcd_points[:, :3])
    ...
    o3d.io.write_point_cloud(f"{pcd_output_dir}/table_point_cloud.ply", pcd_clus)
    ...
    np.save(f"{pcd_output_dir}/gate_mask.npy", gate_mask)
    np.save(f"{pcd_output_dir}/gate_points.npy", gate_pcd_points[:, :3])
    ...
    np.save(f"{pcd_output_dir}/gate_centroid.npy", gate_centroid)
    ...
    o3d.io.write_point_cloud(f"{pcd_output_dir}/gate_point_cloud.ply", gate_pcd_clus)
    ...
    np.save(f"{pcd_output_dir}/gate_bottom_mask.npy", gate_bottom_mask)
    np.save(f"{pcd_output_dir}/gate_bottom_points.npy", gate_bottom_pcd_points[:, :3])
    ...
    # Save gate centroid to npy file
    np.save(f"{pcd_output_dir}/gate_bottom_centroid.npy", gate_bottom_centroid)
